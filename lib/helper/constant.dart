...
const kAnotherButton = 'assets/images/Ellipse68.png';
const kIsPageButton = 'assets/images/Ellipse69.png';
const kButtonColor = Color(0xff0075FE);
const kTextFieldColor = Color(0xffC2C2C2);
const kLogoColor = Color(0xffFF9500);
const kTextColor = Color(0xff022B3A);
const kTextButtonColor = Color(0xff0062D6);
